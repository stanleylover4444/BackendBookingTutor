...
//     if (!tutorObjectId || !studentObjectId) {
//       res.status(400).json({
...
//       User.findById(tutorObjectId).select("fullName"),
//       Customer.findById(studentObjectId).select("fullName"),
//     ]);
...
//       return;
//     }
//     console.log("sendAppointmentCreated")
